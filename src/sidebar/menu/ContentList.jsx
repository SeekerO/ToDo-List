...
const ContentList = ({ openMenu }) => {
  ...
  return (
    <div>
      <h4 className="mt-4 text-[11px] font-semibold">LIST</h4>
      {List.map((List, index) => (
        <div
          key={index}
      ...
      <div className=" mt-1 flex items-center gap-2 p-1 w-full hover:shadow-md hover:shadow-slate-400 rounded-md cursor-pointer">
        <GoPlus />{" "}
        {openMenu && (
